...
const ArticleComponents = () => {
    const {value1, value2, value3} = useContext(Content);
 ...
 <div className={styles.featured_Articles_Component}>
     ...
     {   // eslint-disable-next-line
      ...
      if(index>=bollywood.length-1) {
         return(
      <div key={index} className={styles.featured_Articles_Box_Big} style={   {backgroundImage: `url(${article.ImageAsset})`,  backgroundPosition: 'center',  backgroundSize: 'cover',   backgroundRepeat: 'no-repeat' }  }>
     ...
     if(index>=hollywood.length-1) {
            return(
     <div key={index} className={styles.featured_Articles_Box_Small} style={   {backgroundImage: `url(${article.ImageAsset})`,   backgroundPosition: 'center',   backgroundSize: 'cover',  backgroundRepeat: 'no-repeat'  }  }>
    ...
    technology.map(  (article, index) => {
     ...
     return(
     <div key={index} className={styles.featured_Articles_Box_Small} style={   {backgroundImage: `url(${technology[technology.length - 1].ImageAsset})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }  }>
